 ...
 */
//TODO canMove with more than 1 step + which line of code
//TODO minimalradius final or not
//TODO ask documentation => pre and post conditions constructor and setters
//TODO ask overflow getMass()
//TODO getter maxActionPoints vs separate variable
//TODO implementation of resetMaxActionpoints makes sense?
//TODO what about field boundaries? checker iswithinboundaries
//TODO if worm can't jump and you try, set actionpoints to 0?
//TODO jumptime divide by zero
//TODO in method getMass() => the (4/3)?

/**
 * A class with the implementation of the commands of the worm.
 * 
 * @author Niels Claes
 * 
 */
public class Worm {
	 ...
	 * 
	 * @effect 	The X and Y coördinates of the worm are set to the given values if they are valid.
	 * 			| if isValidX(x) && isValidY(y) && isWithinBoundaries(x,y)
	 * 			| 		then new.getX() == x && new.getY() == y
	 * @effect 	The direction of the worm is set to the given value if it is valid.
	 * 			| if isValidDirection(direction)
	 * 			| 		then new.getDirection() == direction
	 * @effect 	The radius of the worm is equal to the given value if it is valid.
	 ...
	 * @effect	The amount of action points is set to the maximum number of actionpoints if it is valid.
	 ...
	 *          |		then throw new ModelException
	 * @throws 	ModelException
	 *          Throws a ModelException if the new coördinates
	...
	/**
	 * Checks whether the specified x and y coördinates would result in the worm
	 ...
	 * 			The specified y coördinate expressed in meters.
	 * 
	 * @return 	True if the new coördinates are within the playfield boundaries.
	 * @note	The implementation of this method has not yet been done, it will always return true.
	 * 			This method is here for adaptability.
	 */
