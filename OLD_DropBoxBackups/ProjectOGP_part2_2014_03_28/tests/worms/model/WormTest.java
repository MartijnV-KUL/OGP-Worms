...
/**	private static final double EPS = Util.DEFAULT_EPSILON;
	...
	@Test
	public void test_activeMove_MultipleSteps() {
		worm.activeMove(3);
		assertEquals(4.121320343559642, worm.getX(), EPS);
		assertEquals(5.121320343559642, worm.getY(), EPS);
	}
	...
	@Test
	public void test_canTurn_directionIsInfinite() {
		assertFalse(worm.canTurn(Double.POSITIVE_INFINITY));
		assertFalse(worm.canTurn(Double.NEGATIVE_INFINITY));
	}
	@Test
	public void test_canTurn_directionTooHigh() {
		assertFalse(worm.canTurn(Double.MAX_VALUE));
	}
	@Test
